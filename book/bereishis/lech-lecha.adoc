...
. What honors are each of the <<Avos>> given in <<Shmoneh-Esrei>>? What special honor does <<Avrohom>> get?
...
. Why did <<Avrohom>> go to <<Shchem>>? To <<Eilon-Moreh>>? (Think about future connections.)
...
. “And it was when <<Avrohom>> came to <<Mitzrayim>>,” etc. Where was <<Sara>>?
...
. Why is the river <<peras>> called ‘the great river’?
...
. In <<Tanya>> (ch. 23) it says that the <<Avos>> were like a <<merkava>>. Prove it from a <<posuk>> in this <<parsha>>.
