...
. Why did <<Yaakov>> send <<Yoseif>> to <<Shchem>>? Did <<Yoseif>> agree to go? This was heroic. Why?
...
. Prove that learning <<Torah>> exempts a person from *<<kibud-av-vaem>>*.
...
. Why is the word <<yad>> mentioned here four times (in various forms)?
