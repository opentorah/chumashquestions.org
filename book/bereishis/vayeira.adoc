...
. Who were the first ones to give and receive <<kos-shel-brocho>>? Proof?
...
. How do we know that a person who leaves a son, a <<tzadik>>, lives on and on?
...
. Bring a proof that lack of <<yiras-shamayim>> can lead to murder.
...
. What are the purposes of reading this story every day in <<Shacharis>>?
