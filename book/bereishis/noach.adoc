...
. The dove ([.verse]#יוֹנָה#) was sent out many times. How many? What happened each time?
...
. Sara was called [.verse]#יִסְכָּה#. What are the various meanings of this name?
