...
. “In his generations,” etc. (<<posuk>> 1) What is the dispute among <<Chazal>> about this?
...
. For how many years did <<Noach>> build the <<taiva>>? Why was *this* safety method used?
...
. The dove (<<yonah>>) was sent out many times. How many? What happened each time?
...
. From which kinds of animals and birds did <<Noach>> take <<korbanos>>? (See 8:19.)
...
. When does a person get his <<yetzer-horah>>? Explain.
...
. It is said that we have a reference here to the punishment of <<olom-haboh>>. Explain.
...
. What was the curse that <<Noach>> put on <<Canaan>>? Why?

. What is hinted here about the difference between the first and second <<beis-hamikdash>>?
...
. What was the punishment of the <<dor-haflaga>>?
...
. <<Sara>> was called <<yiskah>>. What are the various meanings of this name?
