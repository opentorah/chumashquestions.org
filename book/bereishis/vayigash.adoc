...
. What lesson in <<hashgocha-protis>> can we derive from his words?
...
. Who are <<Yaakov>>’s two granddaughters? How many people left <<Canaan>>?
...
. How does the above relate to the giving of <<tzedakah>>?
