...
. Regarding both sheep and fowl, it says, _‘<<reiach-nichoach>>.’_ What does this teach us?

. Why does it say _‘<<venefesh-ki-takriv>>’_ only in reference to a <<korban-minchah>>?
...
. All <<korbanos>> required *salt*. Why is this called <<bris>>?
...
. Prove that <<Hashem>> loves <<am-yisroel>> more than He loves the <<kohein-gadol>>.

. What kind of <<aveiros>> are described in <<pesukim>> 5:1-3?
