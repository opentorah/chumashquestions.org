...
. Why did the people feel *embarrassed* as long as the <<Shechina>> didn’t come?
...
. How is a <<kal-vachomer>> used to determine the status of certain animals?
...
. Carrying a <<sheretz>> is worse than just touching it. How? (Difference between <<tumas-maga>> and <<tumas-masa>>.)

. A person who has a <<sheretz>> for a pet, is he <<tomei>>? Proof?
...
.. A <<vlad-hatumah>> cannot bring tumah to <<keilim>>, only to food.
