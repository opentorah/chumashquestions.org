...
. Can the <<metzora,metzorah>> be cleansed at night? Proof?

. The <<metzora,metzorah>> is put outside of the camp (or city). How does the <<Kohein>> see him?

. Can you bring an example from the <<mivtzoyim>> which is similar to the above?

. Why does the <<metzora,metzorah>> bring *birds* for his cleansing?

. The species of the birds is not mentioned. Which birds are not acceptable?

. Why does the <<metzora>> bring the <<eitz-erez>>, <<sheni>>, <<tolaas>>, <<eizov>>?

. What is done with the *two birds* (with the items from the previous question)?

. What does the <<metzora>> do on the *first* day of his cleanliness? On the *eighth*
day?

. On which parts of the <<metzora>>’s body do they put the *blood*? The *oil*?
...
. A <<metzora>> who is poor, how are his <<korbanos>> different?
