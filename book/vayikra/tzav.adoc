...
. If the [.verse]#kometz# from the above Menachos was taken without <<kavana>> (intention), is it OK?
...
. When is eating a <<korban>> punishable by [.verse]#koreis#?
...
. One part of a <<korban>> was burned on the <<mizbeyach>> *only during the [.verse]#miluim#*. Which?
