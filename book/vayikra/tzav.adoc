...
. If the <<kometz>> from the above <<Menachos>> was taken without <<kavana>>, is it OK?
...
. When is eating a <<korban>> punishable by <<kares>>?

. What is the punishment for eating <<cheilev>>? Blood?
