...
. Which one of her <<korbanos>> actually causes her to become <<tahor>>?
...
. Sometimes the person is declared <<tahor>> yet must wash (<<tovel>>) himself and his clothes. Why?

. After being locked up what has to happen to his <<negah>> to make him <<tomei>>? <<tahor>>?

. What is the general difference between these: <<sees>>, <<sapachas>>, <<baheres>>?
...
. Explain these: <<nesek>>, <<bohak>>, <<tzareves>>, <<kereach>>, <<gibeiach>>.

. What is a <<metzora>> supposed to do to his clothes? To his hair? What does he announce?
...
. If after washing it, it reappears again what is done to the <<beged>>?

. If the <<negah>> was removed after washing it, what is done to the <<beged>>?

. Are there <<negayim>> today? Why? How is this connected to the <<Golus>>?
