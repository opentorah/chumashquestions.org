...
. If a non-<<Kohein>> eats <<terumah-term>>, <<beshogeg>> or <<bemeizid>>, what happens to him? Can he atone for it in some way?
...
. Why is it best to count <<sefira>> at the start of night not later?
