...
. What are the examples given for these deeds: <<masos-term>>, <<osos>>, <<mofsim>>,
...
. In <<posuk>> 5:19 it says “<<velo-yasaf>>.” What are the two meanings here?
...
. How is the relationship between a <<rebbi>> and <<talmid>> described here?
...
. Explain the differences: <<mizbeyach>>, <<matzeivah>>, <<asheirah>>, <<pesilim>>. (See <<posuk>> 7:6.)
...
. Twice in the <<parsha>> is the word <<hayom>> emphasized (“That I command you *today*”). What are the two messages here?
