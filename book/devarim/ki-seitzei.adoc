...
. “The Torah only spoke (here) against the yetzer horah.” Where is this applied?
...
. What are the two penalties for a [.verse]#מוֹצִיא שֵׁם רַע#?
...
. How does a divorce ([.verse]#גֵּט#) proceed? May the divorced couple remarry each other?
...
. Do we give [.verse]#פֵּאָה# from fruit trees? Proof?
...
. Why is the subject of [.verse]#מַלְקוֹת# written next to the above prohibition?

. Prove that it is against the Torah law to hit a person (even a bad person).

. In what cases does the mitzvoh of [.verse]#יִבּוּם# *not* apply?

. And where does [.verse]#חֲלִיצָה# apply? How is it done?
