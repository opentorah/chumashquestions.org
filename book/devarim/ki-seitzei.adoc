...
. What is the connection between the <<Parshios>> of <<shiluach-hakan>>, <<kilayim>>, <<kilayim>> in plowing, <<kilayim>> in garments, and <<tzitzis>>?
...
. What are the two penalties for a <<motzi-shem-ra>>?
...
. Do we give <<peah>> from fruit trees? Proof?
