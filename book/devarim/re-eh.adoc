...
. At <<Grizim,Mount Grizim>> and <<Evol>>, what was said first, the curses or the blessings? Proof?
...
. Not just the idols must be destroyed, but also the *<<mizbeyach>>*, *<<matzeivah>>*, the *<<asheirah>>*, and even the *names* of the idols. Explain.
...
. Prove that during the time of <<Moshe>>, the laws of <<kosher>> slaughtering were already known. How do we know these laws today?
...
. How does a city turn into an <<ir-hanidachas>>?
...
. We are said here to have two kinds of <<kedusha>>. What are they?
...
. Explain: <<leket>>, <<shikchah>>, <<peah>>, <<hefker>>.
...
. Why is <<matzo>> called <<lechem-oni>>?
...
. There are two contradictory <<pesukim>> about eating <<matzo>>. How is it resolved?
