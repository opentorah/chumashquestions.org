...
. Can a <<Kohein>> work during a time which is not his [.verse]#מִשְׁמָר# (period)? Does he share in the <<korbanos>> if he did work? Explain.

. “Do not *learn to do* their abomination,” etc. Can you *sometimes* learn it?

. Explain the following: [.verse]#קֹסֵם#, [.verse]#מְעוֹנֵן#, [.verse]#מְנַחֵשׁ#, [.verse]#מְכַשֵּׁף#,
[.verse]#חֹבֵר#.
...
. When are the *contradicted witnesses* ([.verse]#עֵדִים זוֹמְמִין#) punished? How? When not?

. In which case is it said that the [.verse]#עֵדִים זוֹמְמִין# are punished like the man but not like the woman?
