...
. Can a <<Kohein>> work during a time which is not his <<mishmar>>? Does he share in the <<korbanos>> if he did work? Explain.

. “Do not *learn to do* their abomination,” etc. Can you *sometimes* learn it?

. Explain the following: <<kosem>>, <<meonen>>, <<menachesh>>, <<mechashof>>,
<<chover>>.
...
. When are the *contradicted witnesses* (<<eidim-zomemim>>) punished? How? When not?

. In which case is it said that the <<eidim-zomemim>> are punished like the man but not like the woman?
...
. What is the dispute between <<Rabbi-Akiva>> and <<Rabbi-Yosai-Haglili>> here?
...
. The seven nations of <<Canaan>>, could they ever be accepted in our midst?
...
. Which city must bring the <<egloh-arufoh>>?
