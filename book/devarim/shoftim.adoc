...
. Can a <<Kohein>> work during a time which is not his [.verse]#mishmor# (period)? Does he share in the <<korbanos>> if he did work? Explain.

. “Do not *learn to do* their abomination,” etc. Can you *sometimes* learn it?

. Explain the following: [.verse]#kosem#, [.verse]#me'onen#, [.verse]#menachesh#, [.verse]#mechashef#,
[.verse]#chover#.
...
. When are the *contradicted witnesses* ([.verse]#edim zomemin#) punished? How? When not?

. In which case is it said that the [.verse]#edim zomemin# are punished like the man but not like the woman?
