...
. What do we take for [.verse]#זְרוֹעַ# (according to the Lubavitcher custom)?
...
. When do the <<bechorim>> fast if the first day of <<Pesach>> falls on a Sunday? When is a [.verse]#סִיּוּם# made?
