...
. What do we take for [.verse]#zroah# (according to the Lubavitcher custom)?
...
. When do the <<bechorim>> fast if the first day of <<Pesach>> falls on a Sunday? When is a [.verse]#siyum# made?
