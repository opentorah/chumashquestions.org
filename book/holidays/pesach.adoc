...
. Why is <<shmurah>> <<matzo>> better than machine <<matzo>>?
...
. Are children required to eat <<marror>>? Could it be grated or chopped?
...
. What do we take for <<zeroa>> (according to the Lubavitcher custom)?

. How is the <<charoses>> prepared? The salt water? Why do we eat less than a <<kezayis>>?

. When one eats the <<korech>> can he *swallow* <<matzo>> and <<marror>> separately?
...
. Why do we spill drops of wine when reciting the ten <<makos>>?
...
. Why do people have so many <<chumrahs>> on <<Pesach>>?
