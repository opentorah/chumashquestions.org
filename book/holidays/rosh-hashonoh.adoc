...
. Are the <<Rosh-Hashonoh>> <<trop>> the same as on <<Shabbos>>?
...
. There are at least ten reasons (from <<Rabbi-Sadya-Gaon>>) for the <<mitzvoh>> of <<shofar>>. How many do you know?
...
. What are the special additions in <<davening>> for <<aseres-yemei-teshuvah>>? Do we say <<Selichos>>? Do other shuls
say it?
...
.. <<tekias-dimeumad>>, <<tekias-dimeyushav>>
.. <<meah-kolos>>
.. <<kesivah-vachasimah-tovah>>
.. <<gemar-chasimah-tovah>>
.. <<sifran-shel-tzadikim>>, <<pidyon>>, <<ohel>>
.. <<lealtar-lechaim>>
.. <<shonoh-tovah-umesukah>>
.. <<malkiyos>>, <<zichronos>>, <<shofaros>>
.. <<hataras-nedarim>>
