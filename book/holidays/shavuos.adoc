...
. Many communities say [.verse]#תִּקּוּן# Shavuos night (and some study). Why?

. Why is there a <<minhag>> to daven <<Maariv>> *late* on Shavuos night?

. Which Haftorahs are read on the two days? Why?
...
. When we said ‘[.verse]#נַעֲשֶׂה וְנִשְׁמָע#’ (we shall do and we shall listen) we were immediately rewarded. How?
...
==== The Book of Ruth
[start=38]
. Why is Megillas Ruth read on Shavuos (in Tikun or in public)? Who wrote it? Why?
