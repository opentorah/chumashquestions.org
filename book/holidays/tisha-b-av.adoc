...
. in such a case, by which time must <<shalosh-seudos>> be finished on <<Shabbos>>/<<Erev>> <<Tisha-B-Av>>?
...
. What is the special way <<Eicha>> is read?
