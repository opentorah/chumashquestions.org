...
. How is sitting in the <<sukkah>> a display of <<bitachon>> in <<Hashem>>?
...
. How much <<s-chach>> is considered enough? What is our <<minhag>>?
...
. Which things are permitted to be done on <<chol-hamoed>>?
...
. Which conditions make each of the four species <<mehudar>>? Are three species enough?
...
. How is the <<lulov>> used during <<davening>>?
...
. May one enjoy the good aroma of the <<esrog>>? <<hadasim>>? Why?
...
. What special <<minhag>> is observed on <<shemini-atzeres>>?
...
. Someone said that we will not be putting on <<tefillin>> for ten days in a row during <<Sukkos>>; but <<Sukkos>> is only nine days long. Explain.
