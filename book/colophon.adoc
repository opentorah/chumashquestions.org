...
link:/book/book/acknowledgments.html[Acknowledgments].
...
link:/book/book.html[one HTML file],
...
https://github.com/dubinsky/site-publisher[Podval site publisher].

Copyright 1995-2026 by the Wichnin family.
