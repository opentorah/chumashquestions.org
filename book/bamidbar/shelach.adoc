...
. Why were the <<meraglim>> told to see the <<Negev>> first?
...
. The obligation to give <<chalah>> starts at a different time than other gifts. How? Proof?

. How much <<chalah>> must be given? Who gets it? And today?
...
. How is the story of the <<mekoshesh>> an embarrassment for the community?
...
. Why are these three subjects written next to each other: <<avodah-zorah>>, <<Shabbos>>, and <<tzitzis>>? (According to <<Rabbi-Moshe-Hadarshon>>.)
