...
. Why does this <<parsha>> follow the (ending of the) previous one?
...
. How do we prove that <<machlokes>> is punished more severely than other sins?

. What test did <<Moshe>> propose to see who is right?
