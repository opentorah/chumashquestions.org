...
. What kind of a <<neder>> cannot be made?
...
. How come <<Bilam>> was there at that time? What happened to him? What ‘exchange’ took place between <<Bilam>>’s methods and the Jews’ method?
...
. <<Elazar>> started his lesson with the word <<ach>>. Why? (Two reasons.)
