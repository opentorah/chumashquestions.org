...
. “And the <<Canaanite>> King of <<Arad>> heard,” etc. Why is it mentioned here?
...
. <<Yehoshua>> repeated the same warning to <<bnei-yisroel>>. Where? Why?
...
. The two-and-a-half tribes on the east side of <<Yarden>> got the same amount of cities of refuge (three) as the entire <<land-of-Israel>>. Why?
...
. The heads of the <<Gilad>> family approached <<Moshe>> with certain concerns. What were they?
