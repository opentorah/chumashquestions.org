...
. How many black hairs disqualify a <<para-adumah>>? Proof?
...
. How does he become cleansed? Can one become <<tomei>> without *touching* a <<meis>>?

. One who *touches* the water (mixed with ashes) is tomei differently. How?

. Who is called <<avi-avos-hatumah>>? <<av-hatumah>>? <<Rishon>>? <<Sheini>>?

. According to <<Rabbi-Moshe-Hadarshon>>, what is the symbolism in the following:
[upperalpha]
