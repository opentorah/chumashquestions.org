...
. How many times were the Jews counted? On which occasions?
...
. A man whose father is from a different <<sheivet>> than his mother, to which <<sheivet>> does he belong?
In which cases does one follow the *mother’s* status?
...
. There were 273 <<bechorim>> more than there were <<Levi-im>>. What happened to them?
...
. <<Elazar>> and <<Issamar>> (<<Aharon>>’s sons) had special charges. What?
