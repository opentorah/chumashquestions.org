...
. Why is the family and position of <<Kozbi>> mentioned here?
...
. Is the total number here the same as the number in <<parshas>> Bamidbar?
...
. Which person had the <<zechus>> to complete the number 70 for the Jewish people in <<Mitzrayim>>? Proof?
...
. What was the special order for the <<korbanos>> (bulls) on the holiday of <<Sukkos>>? How many were there in total?
...
. What is the name for the 8th day of <<Sukkos>>? Reasons?

. What good advice does the <<Torah>> give us about the <<korbanos>> that were donated during the year (<<nedorim>>, <<nedovos>>)?

. What is the significance of the single ox and single ram that we must bring on the day of <<shemini-atzeres>>?

. Why does the <<parsha>> end off with the statement that <<Moshe>> spoke to the Jews “in all that he was commanded”?
