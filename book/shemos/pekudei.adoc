...
. How many <<maneh>> does a regular <<kikar>> hold? A ‘holy’ <<kikar>>?

. How do we get a number (count) of 100 <<kikar>> plus 1775 <<Shekalim>>?

. Which <<adanim>> were made of silver and which of copper?
...
. What special <<parsha>> do we read for <<maftir>>? Why? What are the other three <<Parshios>> (from the set of ‘four parshiyos’)?
...
. The <<avneit>> had <<shatnez>> in it. Who wore it? (See <<Rashbam>> 39:29.)
