...
. “Don’t kindle fire,” etc. Why is this <<melacha>> singled out?
...
. What did the <<nesiyim>> bring? When? Why?
...
. Prove that in the presence of <<Hashem>> there is no difference between the high <<shevatim>> and the lowest one.

. What strange announcement did <<Moshe>> command to announce in the camp?

. How many <<adanim>> and how many <<yados>> were there per <<keresh>>?
...
. Which items that were needed for the <<avodah>> are not mentioned here?
...
==== Extra
[start=21]
. What were the dimensions of the following: <<mizbeyach-haolah>>, <<mizbeyach-hazahav>>, <<aron>>, <<shulchon>>, <<menorah>>, <<kiyor>>?

. Why is the prohibition against fire on <<Shabbos>> mentioned here? (See <<Sforno>>, <<Rambam>>.)

. Why did <<Moshe>> have to *gather* the people *here*? (See <<Ohr-Hachayim>>.)
...
[start=31]
. How many *special* <<Parshios>> do we read between now and <<Pesach>>? What are their names?

. Why do we read <<parshas>> <<Shekalim>> on this <<Shabbos>>? Which part do we read?

. What is the source and reason for the saying, _‘<<mi-shenichnas-adar>>’_?
