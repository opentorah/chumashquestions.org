...
. Can an [.verse]#eved nirtza# be a slave forever? Until when? Source?
...
. Explain these terms: [.verse]#nezek#, [.verse]#tzaar#, [.verse]#ripui#, [.verse]#sheves#, [.verse]#boshes#.
...
. Explain the terms: [.verse]#mazik#, [.verse]#nizak#, [.verse]#tam#, [.verse]#mu'od#, [.verse]#kofer#.

. When a person makes a pit ([.verse]#bor#), which kind of damages is he responsible for?
...
.  If a [.verse]#shomer khinom# claims the article was stolen, what happens to him?

.  In the case of a [.verse]#shomer sokhor#, when is he held responsible?

.  A person who is a [.verse]#sho'eil# (one who borrowed), could he ever be exempt from payment?

.  What about a person who rents a tool from someone (a [.verse]#soicher#), how is he responsible?

. For which kind of worship-of-idols does one get the death penalty?

. What kind of prohibitions are written concerning a [.verse]#ger# (convert)? Reason?
...
. Where is the [.verse]#din# of [.verse]#modeh b'miktzas# (partial admission) derived from?

. What are the warnings given about [.verse]#bikurim# (first fruits), [.verse]#terumah# and [.verse]#maaser#?

. Why is the [.verse]#din# of <<pidyon-ha-ben>> (redemption of the first born) mentioned here again?
