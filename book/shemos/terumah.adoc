...
. Which items of the <<Mishkan>> are described in this <<parsha>>?
...
. How did they get <<sheetim>> wood in the desert?

. In <<posuk>> 9 why does it say “and so you shall do” after saying it in <<posuk>> 8? Were the <<keilim>> in the first <<beis-hamikdash>> similar to those in the <<Mishkan>>? Why?

. Why does it say in <<posuk>> 8, “And I shall dwell *in them*,” rather than in *it*?

. How was the <<aron>> ‘covered’ with gold inside and outside? What were its dimensions? Which <<neis>> is related to its space?

. Why was there a ‘crown’ made on top of the <<aron>>?

. What other parts did the <<aron>> have besides the ‘boxes’ and the ‘crown’?

. What were these: <<tabaos>>, <<badim>>, <<edus>>, <<kapores>>, <<zer>>, <<tzlaos>>?
...
. The <<shulchon>> also had a ‘crown.’ Why? Where was it placed?
...
. What were the <<adanim>>? What were they used for? How many were there? Which donations went into the making of the <<adanim>>?

. What were the <<berichim>>, <<tabaas>>, <<yados>>?
...
. How big was the <<chatzer>> of the <<Mishkan>>? And its curtains?

. What was the purpose of the <<masach>> for the <<Mishkan>> and the one for the <<chatzer>>? Their dimensions?
