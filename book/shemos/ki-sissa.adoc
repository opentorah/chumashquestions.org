...
. How many <<zuzim>> in a <<shekel>>? How many <<geirah>> in a <<zuz>>?
...
. How many herbs were used for the <<ketores>>? How many are mentioned?
...
. How does <<Rashi>> explain <<chochmah>>, <<tevunah>>, <<daas>>?
Is this similar to the explanation given in <<Tanya>> for <<chochmah>>, <<binah>>, <<daas>>? How?
...
. What are the punishments for desecrating the <<Shabbos>>? <<beshogeg>>, <<bemeizid>>, <<behasraah>>?
...
. Why is the <<Torah>> likened to a <<kalah>>? (Two reasons.)
...
. After <<Aharon>> threw the gold into the fire, *who* produced the <<egel-hazahav>>? (Two opinions.)

. Prove that the mixed multitude of <<erev-rav>> started the whole thing.
...
. What reason did <<Moshe>> have (from a <<halacha>>) to break the <<Luchos>>?
...
. Did any of the <<Levi-im>> participate in the <<chet-ha-egel>>? Proof?
...
. Explain the following (two meanings): _<<notzer-chesed>>; <<nosei-avon>>; <<vechataah>>; <<venakeh>>; <<lo-yenakeh>>_.
...
. “And you shall rest from plowing and harvesting.” What does this teach us about <<Shabbos>>?
What other interpretation is there concerning the laws of the seventh year (<<shmittah>>)?
...
. How do we know that it’s forbidden to write down <<torah-shebe-al-peh>>? Then why do we have <<Mishna>>, <<Gemora>>, <<shulchon-oruch>>?
...
. When do we recite the <<pesukim>> of <<veshamru>> (31:16)?
...
. Which <<yomim-tovim>> are *not* mentioned in this <<parsha>>? Why?
