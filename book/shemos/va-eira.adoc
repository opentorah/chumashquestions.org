...
. How were the <<Avos>> considered better than <<Moshe>>?
...
. Why did <<Aharon>>, not <<Moshe>>, bring the <<makah>> of blood?
...
. After the <<makah>> of <<arov>> what happened to the animals?
...
. Which miracles had to occur during the <<makah>> of <<sh-chin>>?

. Which cattle were not hurt by the <<makos>> of <<dever>> and <<bored>> (death and hail)? Proof?

. Which miracle occurred during the <<makah>> of <<bored>>? What can we learn from it?

. Why did <<Moshe>> insist on <<davening>> outside of the city during the <<makah>> of <<bored>> but not during the <<makah>> of <<tzefardeia>>?

. Which <<makah>> equaled all the other <<makos>> in severity?

. How can we learn the <<midoh>> of gratitude from some of the <<makos>>?
